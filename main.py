...
label_title = tk.Label(frame1, text="Intelligent Surveillance Support System")
label_font = font.Font(size=35, weight='bold',family='Helvetica')
label_title['font'] = label_font
label_title.grid(pady=(10,10), column=2)


icon = Image.open('icons/griet.png')
icon = icon.resize((486,103), Image.LANCZOS)
